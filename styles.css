...
(function () {
  ...
  function tabbar(active) {
    const tabs = [
      ...
      { id: 'trades', th: 'เทรด', en: 'Trades', d: 'M4 6h16M4 12h16M4 18h10' },
  ...
  const SCREENS = {
    ...
    trades() {
      const rows = [
        { t: 'GOOGL', a: 'stk', s: 'Long Stock', p: '+$2,140', cls: 'pos' },
        { t: 'PLTR', a: 'stk', s: 'Long Stock', p: '+$880', cls: 'pos' },
        { t: 'NVDA', a: 'opt', s: 'Sell Put', p: '+$500', cls: 'pos' },
        { t: 'TSM', a: 'stk', s: 'Long Stock', p: '-$320', cls: 'neg' },
        { t: 'AAPL', a: 'opt', s: 'Covered Call', p: '+$312', cls: 'pos' },
        { t: 'SOFI', a: 'stk', s: 'Long Stock', p: '+$1,050', cls: 'pos' },
        { t: 'CLS', a: 'opt', s: 'Sell Put', p: '+$418', cls: 'pos' },
      ];
      return `
        ${statusBar}
        <div class="scr-head">
          <div>
            <div class="scr-title"><span class="th">เทรด</span><span class="en">Trades</span></div>
            <div class="scr-sub">26 <span class="th">รายการ</span><span class="en">positions</span></div>
          </div>
        ...
        <div class="scr-body">
          ...
          <div class="mini-card" style="padding:4px 11px;">
            ${rows.map(r => `
              <div class="trow">
                <span class="asset-tag ${r.a}">${r.a === 'stk' ? 'STK' : 'OPT'}</span>
